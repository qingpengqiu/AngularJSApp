...
export {
    ...
    TrackingUndealItemsComponent,LimitManageLookComponent,LimitManageNewComponent,RtnListComponent,RtnApplyComponent,BorrowUnclearListComponent,
...
export let BORROW_APP_ENTRY_COMPONENT = [//borrow模块entryComponents
    FiscalAddFormComponent,FiscalModalDataComponent,PlatformModalDataComponent,PlatformEditFormComponent, FreezeAddFormComponent,BorrowUnclearListComponent,PopUnclearListComponent,AddressComponent,
...
export let BORROW_APP_COMPONENT = [//borrow模块内部列表
    ...
    TurnSaleApplyComponent,PopUnclearListComponent,PopInventoryListComponent,BorrowFileUpComponent,AddressComponent,JyWfapprovalComponent,JIqSelectComponent,
