...
import { EcContractCommonClass, serverAddress, producttpladdress, multipleAddress } from "../../common/utilityclass/eccontractcommon";
...
export class HardwareGeneralComponent implements OnInit {
  ...
  public isSingleAddress = true;//是否单送货地址
  //收货人地址
