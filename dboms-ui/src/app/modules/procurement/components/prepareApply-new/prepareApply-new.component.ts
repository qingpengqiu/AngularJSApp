...
@Component({
    templateUrl: 'prepareApply-new.component.html',
    styleUrls:['prepareApply-new.component.scss','./../../scss/procurement.scss']
})
export class PrepareApplyNewComponent implements OnInit {
  ...
  nextStep(){//下一步点击
    if(this.direct){//直接创建
      this.windowService.alert({message:"你将直接创建预下单采购申请",type:"warn"});
