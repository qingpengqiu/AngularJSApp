...
@Component({
    templateUrl: 'contractApply-new.component.html',
    styleUrls:['contractApply-new.component.scss','./../../scss/procurement.scss']
})
export class ContractApplyNewComponent implements OnInit {
