...
@Component({
  ...
  templateUrl: './demo-detepicker.component.html'
})
export class DatepickerDemoComponent {
  @Output() DatepickerDate = new EventEmitter();
  ...
  public formats: string[] = ['DD-MM-YYYY', 'YYYY/MM/DD', 'DD.MM.YYYY',
    'shortDate'];
  public format: string = this.formats[1];
  ...
  public closeDatePicker(){
      ...
      this.DatepickerDate.emit(this.getDate());
