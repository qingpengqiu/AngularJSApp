...
export class ApplyCommonComponent implements OnInit {
    ...
    ngOnInit() {
        this.route.params.subscribe((params) => {
            ...
            this.appParms = {
                ...
                apiUrl_Transfer: this.javaurl + "invoice/delay-applys/flow-transfer",//转办
                parmsMap: { "id": this.applyId, "nodeId": this.nodeId, "isBiggeerTen": this.isBiggeerTen },
    ...
    public saveBill(op) {
        ...
        this.http.post(this.javaurl + 'invoice/delay-applys/agreement', data)
            .toPromise()
            .then(res => {
