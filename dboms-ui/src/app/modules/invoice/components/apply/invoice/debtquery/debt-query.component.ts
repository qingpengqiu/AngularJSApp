...
export class DebtQueryComponent implements OnInit {
  ...
  searchDebt(){
    this.http.post('/api/SalesmanHomePage/GetCustomerUnclear',{"KUNNR":this.debt.customCode,"BUKRS":this.debt.payee,"GSBER":"","END_DATE1":"","END_DATE2":"","AMOUNT1":"","AMOUNT2":""})
          .map(res => res.json())
          .subscribe(res => {
              if(res.Data){
                ...
                item =>{
                  ...
                  item.contractNum=  this.debt.contractNum;
